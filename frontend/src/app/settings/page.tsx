          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select value={model} onChange={(e) => setModel(e.target.value)}
                      ...
                      <option value="gemini-flash">Gemini Flash — Fast, cost-effective</option>
                      <option value="gemini-pro">Gemini Pro — High accuracy</option>
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              <div className="p-5 rounded-2xl border border-amber-500/20 bg-amber-500/5 flex flex-col gap-2">
                ...
                <p className="text-[10px] text-gray-300 leading-relaxed">Gemini Flash is recommended for most audits. Use Pro only for high-value packages where accuracy is critical. BGE-M3 only mode consumes no API tokens.</p>
              </div>
              <button type="submit"
                className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl bg-sky-500 hover:bg-sky-400 text-sm font-bold text-black transition-colors cursor-pointer">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 opacity-70">
                  {[
                    ...
                    <div key={f.label} className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-gray-300">{f.label}</label>
                  ...
                  {[
                    ...
                    <div key={s.type} className="flex items-center justify-between px-4 py-3 rounded-xl border border-zinc-800 bg-zinc-950/60 text-xs">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-300">· {s.zone}</span>
                      </div>
                      <div className="flex items-center gap-4 text-[11px]">
                        <span className="font-mono text-gray-300">{s.ip}</span>
            ...
            <div className="lg:col-span-4">
              <div className="p-5 rounded-2xl border border-sky-500/20 bg-sky-500/5 flex flex-col gap-2">
                ...
                <p className="text-[10px] text-gray-300 leading-relaxed">Source market zones are configured when you set up a package audit. Contact ZeroTrace to request additional market coverage not listed in your plan.</p>
              </div>
            </div>
          </div>
        )}
